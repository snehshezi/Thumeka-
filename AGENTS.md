# Thumeka Project Instructions for Codex

## Project summary

Build Thumeka, a Durban-only mobile-first marketplace for South Africa using ZAR.
...
Provider covers sellers, service providers, and errand runners.
